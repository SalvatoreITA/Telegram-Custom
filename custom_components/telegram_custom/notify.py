...
class TelegramCustomService(BaseNotificationService):
    ...
    async def _send_fallback_text(self, message):
        ...
        try:
            await self._hass.services.async_call(
                ...
                "send_message",
                {
                    "chat_id": self._chat_id,  # FIX WARNING
    ...
    async def async_send_message(self, message="", **kwargs):
        ...
        if "media_group" in data:
            ...
            for i, item in enumerate(items):
                try:
                    ...
                    payload = {"chat_id": self._chat_id, "caption": caption, "parse_mode": parse_mode} # FIX WARNING
        ...
        service_data = {"chat_id": self._chat_id, "parse_mode": parse_mode} # FIX WARNING
        ...
        if media_key == "location":
            ...
            if final_msg:
                await self._hass.services.async_call("telegram_bot", "send_message",
                    {"chat_id": self._chat_id, "message": final_msg, "parse_mode": parse_mode}, blocking=False) # FIX WARNING
            return
            ...
            if len(final_msg) > 4000:
                for part in self.split_message(final_msg):
                    await self._hass.services.async_call("telegram_bot", "send_message",
                        {"chat_id": self._chat_id, "message": part, "parse_mode": parse_mode}, blocking=False) # FIX WARNING
                return
        ...
        excluded_keys = [
            ...
            "reply_markup", "target" # FIX WARNING: aggiunto "target" per ripulirlo
        ]
